...
async function getUrlsFromServer(){
    let response = await fetch('https://md-url.herokuapp.com');
    ...
    tbody.innerHTML = `${
                            urls.map((url)=>{
                               return `<tr>
                                            ...
                                            <td>    
                                                <a href="https://md-url.herokuapp.com/${url.short}" target="_blank">${url.short}</a>
...
function copyText(short){
    ...
    helpInput.value = `https://md-url.herokuapp.com/${short}`;
...
document.getElementById('form').onsubmit = async (e) => {
    ...
    let res = await fetch('https://md-url.herokuapp.com', {
        method: 'POST',
        headers: {
